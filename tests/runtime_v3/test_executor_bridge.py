...
class ExecutorBridgeTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_committed_approval_scope_rechecks_one_use_authority(self):
        calls = 0
        ...
        async def implementation(*args, **kwargs):
            ...
            return ToolResult(
                ...
                error=ToolError(
                    "effect_approval_already_committed",
                    "approval is one-use",
                ),
            )
        ...
        self.assertEqual(second.error.code, "effect_approval_already_committed")
